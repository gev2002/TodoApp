    ...
    >
      <Tab.Screen
        ...
        options={{
          tabBarIcon: (p) => (
            <View>
              <Image source={p.focused ? HomeIconActive : HomeIcon} />
              {p.focused && <Image style={{ marginLeft: 12.5 }} source={ActiveTabIcon} />}
            </View>
          ),
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: (p) => (
            <View>
              <Image source={p.focused ? TodoListIconActive : TodoListIcon} />
              {p.focused && <Image style={{ marginLeft: 13.5 }} source={ActiveTabIcon} />}
            </View>
          ),
          tabBarShowLabel: false,
        }}
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: (p) => (
            <View>
              <Image source={p.focused ? CalendarIconActive : CalendarIcon} />
              {p.focused && <Image style={{ marginLeft: 11.5 }} source={ActiveTabIcon} />}
            </View>
          ),
          tabBarShowLabel: false,
