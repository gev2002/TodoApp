...
import {addTodo, deleteTodo, doneTodo, pinTodo} from "../actions/todos";
...
// export const deleteTodoReducer = createReducer(initialState,(builder)=>{
//     builder
//         .addCase(deleteTodo,(state,action)=>{
//             const filteredTodos= state.data.filter(t=>t.id !== action.payload )
...
// })
//
// export const pinTodoReducer = createReducer(initialState,(builder)=>{
//     builder
//         .addCase(pinTodo,(state,action)=>{
//             const filteredTodos= state.data.filter(t=>t.id !== action.payload )
//             console.log(filteredTodos, 'filter')
...
// })
//
// export const doneTodoReducer = createReducer(initialState,(builder)=>{
//     builder
//         .addCase(doneTodo,(state,action)=>{
//             const filteredTodos= state.data.filter(t=>t.id !== action.payload )
//             console.log(filteredTodos, 'filter')
